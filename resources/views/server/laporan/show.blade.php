...
@section('content')
  <div class="row justify-content-center" style="margin-bottom: 35px;">
    ...
    <div class="col-12">
    @endif
      <div class="card shadow h-100" style="border-top: .25rem solid #00ff7b">
        <div class="card-body">
          <div class="row no-gutters align-items-center justify-content-center">
            ...
            <div class="col-auto">
              <span class="title">
                ...
                <i class="fas fa-ticket-alt" style="color: #00ff7b;"></i>
                </div>
                <div class="title-text ml-1 text-success">Ticket</div>
              </span>
            </div>
          </div>
        </div>
